...
int main() {
  ...
  ComPtr<IMFExtendedDRMTypeSupport> drm_type_support_factory;
  HRESULT hr = CoCreateInstance(
      CLSID_MFMediaEngineClassFactory, nullptr, CLSCTX_INPROC_SERVER,
      __uuidof(IMFExtendedDRMTypeSupport),
      (void**)drm_type_support_factory.GetAddressOf());
  ...
  std::vector<std::wstring> codecs{
      ...
      L"video/mp4; codecs=\"hvc1\";features=\"ext-profile=dvhe.09,%s\"",
      ...
      L"video/mp4; codecs=\"hev1\";features=\"ext-profile=dvhe.09,%s\"",
